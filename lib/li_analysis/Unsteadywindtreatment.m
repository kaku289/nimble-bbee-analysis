classdef Unsteadywindtreatment < handle
    properties (Access = public)
     ...
     methods
         function obj = Unsteadywindtreatment(datenum, pattern, light, wind, startTime, endTime)
             % datenum - YYYYMMDD
             % pattern - checkerboard or spokes or grayscale
             % light - low/medium/high/lower/highest
             % startTime - HHMMSS
             % endTime - HHMMSS
