...
chosen_fac = 1.5;
% behaviour = {'rising','constant','sleeping'};
selected_tracks = {'20190704_153000_170000_obj7984_track234_excerpt1', '20190704_153000_170000_obj9821_track290_excerpt1', '20190708_140000_153000_obj664_track13_excerpt1', '20190704_153000_170000_obj3509_track95_excerpt2'};
...
for ct_pattern=2%1:length(pattern)
    for ct_light=3%1:length(light)
        % Delete previous plots
        if delPreviousPlots && savePlots && exist(fullfile(DirPlots, [pattern{ct_pattern} '_' light{ct_light}]), 'dir')
            rmdir(fullfile(DirPlots, [pattern{ct_pattern} '_' light{ct_light}]),'s');
        end
